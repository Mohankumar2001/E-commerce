...
import { detailsProduct, listProducts, saveProduct, deleteProduct } from '../actions/productActions';
    ...
    return <div className="content content-margined">
        ...
        <form onSubmit={submitHandler}>
            <ul className="form-container">
                ...
                <li><button type="submit" className="button">{id?"Update" : "Create"}</button></li>
                <li><button type="submit" className="button" onClick={() => setModalVisible(false)}>Back</button></li>
            </ul>
        </form>
        </div>
        }
